...
package com.tripas.test1.test1.vectordrawable.vectordrawable;
...
import com.tripas.test1.test1.vectordrawable.utils.AssetUtil;
...
public class VdPreview {
    ...
    public static Document parseVdStringIntoDocument( String xmlFileContent,
    ...
    public static String overrideXmlContent( Document document,
                                             VdOverrideInfo info,
                                             StringBuilder errorLog) {
    ...
    public static BufferedImage getPreviewFromVectorXml( TargetSize targetSize,
    ...
    public static BufferedImage getPreviewFromVectorDocument( TargetSize targetSize,
                                                              Document xml,
                                                              StringBuilder vdErrorLog) {
    ...
    public static BufferedImage getPreviewFromVectorTree( TargetSize targetSize,
                                                          VdTree vdTree,
                                                          StringBuilder vdErrorLog) {
